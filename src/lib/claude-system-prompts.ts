function buildClaudeSystemPrompt(modelName: string) {
  return [
    ...
    'IMPORTANT: Do NOT use web search for general knowledge questions, greetings, casual conversation, code help, writing assistance, math, explanations of well-known concepts, or anything you already know well. Only search when you genuinely need real-time or very recent information that you are unsure about.',
